...
_INDEX_RST_BADGE_CODECOV = '''.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/packageitstructureexample
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/packageitstructureexample

'''
_INDEX_RST_BADGE_GITHUB_CI = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/packageitstructureexample/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/packageitstructureexample/actions/workflows/ci.yaml

'''
_INDEX_RST_BADGE_GITHUB_HITS = '''.. image:: https://img.shields.io/github/search/hendrikdutoit/packageitstructureexample/GitHub hit
    :alt: GitHub Searches

'''
_INDEX_RST_BADGE_GITHUB_LICENSE = '''.. image:: https://img.shields.io/github/license/hendrikdutoit/packageitstructureexample
    :alt: License

'''
_INDEX_RST_BADGE_GITHUB_ISSUES = '''.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/packageitstructureexample
    :alt: GitHub issues

'''
_INDEX_RST_BADGE_GITHUB_PRE_COMMIT = '''.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/packageitstructureexample/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/packageitstructureexample/actions/workflows/pre-commit.yaml

'''
_INDEX_RST_BADGE_GITHUB_RELEASE = '''.. image:: https://img.shields.io/github/v/release/hendrikdutoit/packageitstructureexample
    :alt: GitHub release (latest by date)

'''
_INDEX_RST_BADGE_PYPI_VERSION = '''.. image:: https://img.shields.io/testpypi/v/packageitstructureexample
    :alt: PyPi

'''
_INDEX_RST_BADGE_PYPI_DL = '''.. image:: https://img.shields.io/pypi/dm/packageitstructureexample
    :alt: PyPI - Downloads

'''
_INDEX_RST_BADGE_PYPI_STATUS = '''.. image:: https://img.shields.io/pypi/status/packageitstructureexample
    :alt: PyPI - Status

'''
_INDEX_RST_BADGE_PYPI_WHEEL = '''.. image:: https://img.shields.io/pypi/wheel/packageitstructureexample
    :alt: PyPI - Wheel

'''
_INDEX_RST_BADGE_PYVERSIONS = '''.. image:: https://img.shields.io/pypi/pyversions/packageitstructureexample
...
.. image:: https://img.shields.io/pypi/status/packageitstructureexample
    :alt: PyPI - Status

.. image:: https://img.shields.io/pypi/wheel/packageitstructureexample
    :alt: PyPI - Wheel

.. image:: https://img.shields.io/pypi/pyversions/packageitstructureexample
    :alt: PyPI - Python Version

.. image:: https://img.shields.io/github/v/release/hendrikdutoit/packageitstructureexample
    :alt: GitHub release (latest by date)

.. image:: https://img.shields.io/github/license/hendrikdutoit/packageitstructureexample
    :alt: License

.. image:: https://img.shields.io/github/issues-raw/hendrikdutoit/packageitstructureexample
    :alt: GitHub issues

.. image:: https://img.shields.io/pypi/dm/packageitstructureexample
    :alt: PyPI - Downloads

.. image:: https://img.shields.io/github/search/hendrikdutoit/packageitstructureexample/GitHub hit
    :alt: GitHub Searches

.. image:: https://img.shields.io/codecov/c/gh/hendrikdutoit/packageitstructureexample
    :alt: CodeCov
    :target: https://app.codecov.io/gh/hendrikdutoit/packageitstructureexample

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/packageitstructureexample/Pre-Commit
    :alt: GitHub Actions - Pre-Commit
    :target: https://github.com/hendrikdutoit/packageitstructureexample/actions/workflows/pre-commit.yaml

.. image:: https://img.shields.io/github/workflow/status/hendrikdutoit/packageitstructureexample/CI
    :alt: GitHub Actions - CI
    :target: https://github.com/hendrikdutoit/packageitstructureexample/actions/workflows/ci.yaml

.. image:: https://img.shields.io/testpypi/v/packageitstructureexample
    :alt: PyPi
...
_PROJECT_NAME = "packageitstructureexample"
  ...
  ReleaseToPyPi:
    ...
    steps:
      ...
      - name: Build distributions
        shell: bash -l packageitstructureexample
